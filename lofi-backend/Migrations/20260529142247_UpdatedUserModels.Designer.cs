...
namespace lofi_backend.Migrations
{
    ...
    [Migration("20260529142247_UpdatedUserModels")]
    partial class UpdatedUserModels
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("lofi_backend.Data_Models.Music", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("lofi_backend.Data_Models.Project", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("lofi_backend.Data_Models.Music", b =>
                {
                    b.HasOne("lofi_backend.Data_Models.Playlist", null)
                        .WithMany("Songs")
            ...
            modelBuilder.Entity("lofi_backend.Data_Models.TaskTimer", b =>
                {
                    b.HasOne("lofi_backend.Data_Models.Project", null)
                        .WithMany("Timers")
